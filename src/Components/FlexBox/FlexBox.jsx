      ...
      <div className="flex flex-col md:flex-row w-full">
        <div className="md:w-1/2 p-2">
          ...
          <div className="text-gray-600 text-xl mt-5">
            Gents: <span className="w-25 bg-red-500 p-3 text-3xl font-bold text-white">{gentsCount}</span> Lead by: <span className="font-semibold">Mohammad Ali</span> Ladies: {ladiesCount} Lead by: 
          </div>
        </div>
        <div className="md:w-1/2 p-2">
